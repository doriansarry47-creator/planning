import { db, initializeDatabase } from "../server/db-sqlite.js";
import { users, patients, practitioners, timeSlots } from "../shared/schema-sqlite.js";
import { hashPassword } from "../server/auth.js";

async function initDev() {
  console.log("🌱 Initialisation de la base de données SQLite pour le développement...");
